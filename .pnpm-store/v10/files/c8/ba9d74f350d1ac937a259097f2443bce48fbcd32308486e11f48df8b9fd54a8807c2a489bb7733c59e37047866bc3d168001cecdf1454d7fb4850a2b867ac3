 ...
 */
export declare function useToastManager(): useToastManager.ReturnValue;
export declare namespace useToastManager {
  interface ReturnValue {
    ...
    promise: <Value, Data extends object>(promise: Promise<Value>, options: PromiseOptions<Value, Data>) => Promise<Value>;
  }
  interface AddOptions<Data extends object> extends Omit<ToastObject<Data>, 'id' | 'animation' | 'height' | 'ref' | 'limited'> {
    id?: string;
  }
  interface UpdateOptions<Data extends object> extends Partial<AddOptions<Data>> {}
  interface PromiseOptions<Value, Data extends object> {
