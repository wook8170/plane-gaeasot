 ...
 * @category Layers
 */
export const layerStore = options => Layer.scoped(RateLimiter.RateLimiterStore, make(options));
/**
 * @since 1.0.0
 * @category Layers
 */
export const layerStoreConfig = options => Layer.scoped(RateLimiter.RateLimiterStore, Effect.flatMap(Config.unwrap(options), make));
