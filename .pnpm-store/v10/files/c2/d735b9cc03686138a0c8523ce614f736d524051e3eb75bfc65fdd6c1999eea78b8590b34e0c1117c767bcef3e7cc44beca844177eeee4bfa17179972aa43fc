...
export class Tag extends AbstractPureComponent2 {
    ...
    render() {
        ...
        const removeButton = isRemovable ? (React.createElement("button", { "aria-label": "Remove Tag", type: "button", className: Classes.TAG_REMOVE, onClick: this.onRemoveClick, tabIndex: tabIndex },
