...
export class CollapsibleList extends React.Component {
    static displayName = `${DISPLAYNAME_PREFIX}.CollapsibleList`;
    static defaultProps = {
    ...
    render() {
        ...
        if (collapsedChildren.length > 0) {
            ...
            collapsedPopover = (React.createElement("li", { className: this.props.visibleItemClassName },
                React.createElement(Popover, { content: React.createElement(Menu, null, collapsedChildren), position: position, ...this.props.dropdownProps }, this.props.dropdownTarget)));
        }
