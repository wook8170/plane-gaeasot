...
class Server$1 {
    constructor(hocuspocus, websocketOptions = {}) {
        ...
        this.webSocketServer = new ws.WebSocketServer({ noServer: true, ...websocketOptions });
        this.setupWebsocketConnection();
        this.setupHttpUpgrade();
    }
}
...
class Hocuspocus {
     ...
     * Start the server
     */
    async listen(portOrCallback = null, callback = null, websocketOptions = {}) {
        ...
        this.server = new Server$1(this, websocketOptions);
