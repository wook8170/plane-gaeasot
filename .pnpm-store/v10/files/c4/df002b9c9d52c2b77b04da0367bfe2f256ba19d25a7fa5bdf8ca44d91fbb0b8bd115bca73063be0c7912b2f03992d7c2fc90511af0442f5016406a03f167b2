...
exports.makeTestClient = exports.make = exports.keepAlive = exports.isEntity = exports.fromRpcGroup = exports.TypeId = exports.Request = exports.KeepAliveRpc = exports.KeepAliveLatch = exports.CurrentRunnerAddress = exports.CurrentAddress = void 0;
 ...
 * @category Keep alive
 */
const keepAlive = exports.keepAlive = /*#__PURE__*/Effect.fnUntraced(function* (enabled) {
 ...
 * @category Keep alive
 */
const KeepAliveRpc = exports.KeepAliveRpc = /*#__PURE__*/Rpc.make("Cluster/Entity/keepAlive").annotate(ClusterSchema.Persisted, true).annotate(ClusterSchema.Uninterruptible, true);
/**
 * @since 1.0.0
 * @category Keep alive
 */
class KeepAliveLatch extends /*#__PURE__*/Context.Tag("effect/cluster/Entity/KeepAliveLatch")() {}
exports.KeepAliveLatch = KeepAliveLatch;
