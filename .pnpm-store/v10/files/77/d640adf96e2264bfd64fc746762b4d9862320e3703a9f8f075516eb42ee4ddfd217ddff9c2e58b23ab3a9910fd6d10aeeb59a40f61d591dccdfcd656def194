...
var Popover2Arrow = function (_a) {
    ...
    React.createElement("div", { "aria-hidden": true, className: Classes.POPOVER2_ARROW, "data-popper-arrow": true, ref: ref, style: tslib_1.__assign(tslib_1.__assign({}, style), getArrowReferenceOffsetStyle(placement)) },
