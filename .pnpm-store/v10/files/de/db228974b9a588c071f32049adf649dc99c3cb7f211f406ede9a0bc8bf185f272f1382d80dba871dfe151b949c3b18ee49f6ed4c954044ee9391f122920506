...
const customStyleHookMapping = transitionStatusMapping;
  ...
  const element = useRenderElement('button', componentProps, {
    ...
    props: [{
      ...
      onClick(event) {
        ...
        if (selectionMode !== 'none') {
          store.state.setSelectedValue(Array.isArray(selectedValue) ? [] : null, createBaseUIEventDetails('clear-press', event.nativeEvent));
