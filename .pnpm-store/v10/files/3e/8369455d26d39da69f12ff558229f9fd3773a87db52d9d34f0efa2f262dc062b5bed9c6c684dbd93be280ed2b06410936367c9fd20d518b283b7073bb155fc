...
var ResizeSensor2 = /** @class */ (function (_super) {
    ...
    ResizeSensor2.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".ResizeSensor2");
    return ResizeSensor2;
}(core_1.AbstractPureComponent2));
exports.ResizeSensor2 = ResizeSensor2;
