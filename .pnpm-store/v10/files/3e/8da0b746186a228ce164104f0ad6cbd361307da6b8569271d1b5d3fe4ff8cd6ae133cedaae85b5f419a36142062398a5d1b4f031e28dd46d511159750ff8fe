...
export declare function getMinListIndex(listRef: React.RefObject<Array<HTMLElement | null>>, disabledIndices: DisabledIndices | undefined): number;
...
export declare function findNonDisabledListIndex(listRef: React.RefObject<Array<HTMLElement | null>>, {
  startingIndex,
  decrement,
  disabledIndices,
  amount
...
export declare function isListIndexDisabled(listRef: React.RefObject<Array<HTMLElement | null>>, index: number, disabledIndices?: DisabledIndices): boolean;
export {};