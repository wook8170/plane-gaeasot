...
export var ContextMenu2Popover = React.memo(function _ContextMenu2Popover(props) {
    ...
    return (React.createElement(Popover2, __assign({ placement: "right-start", rootBoundary: rootBoundary, transitionDuration: transitionDuration }, popoverProps, { content: 
