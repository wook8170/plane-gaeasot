...
export declare function getOppositePlacement(side: BasePlacement): "top" | "bottom" | "right" | "left";
/** Returns the CSS alignment keyword corresponding to given placement. */
export declare function getAlignment(placement: Placement): "right" | "left" | "center";
