...
const RequestFromSelf = exports.RequestFromSelf = /*#__PURE__*/Schema.declare(u => isEnvelope(u) && u._tag === "Request", {
  typeConstructor: {
    _tag: "effect/cluster/Envelope.Request"
  },
  identifier: "Envelope"
});
/**
