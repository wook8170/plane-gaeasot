 ...
 * @category Keep alive
 */
export const KeepAliveRpc = /*#__PURE__*/Rpc.make("Cluster/Entity/keepAlive").annotate(ClusterSchema.Persisted, true).annotate(ClusterSchema.Uninterruptible, true);
/**
 * @since 1.0.0
 * @category Keep alive
 */
export class KeepAliveLatch extends /*#__PURE__*/Context.Tag("effect/cluster/Entity/KeepAliveLatch")() {}
