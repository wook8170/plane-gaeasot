...
export var ContextMenu2 = React.forwardRef(function (props, userRef) {
    ...
    var renderMenu = React.useCallback(function (menuContentProps) {
        return disabled ? undefined : CoreUtils.isFunction(content) ? content(menuContentProps) : content;
    }, [disabled, content]);
    ...
    var maybePopover = menuContent === undefined ? undefined : (React.createElement(ContextMenu2Popover, __assign({}, popoverProps, { content: menuContent, isDarkTheme: isDarkTheme, isOpen: isOpen, targetOffset: targetOffset, onClose: handlePopoverClose })));
    var handleContextMenu = React.useCallback(function (e) {
        ...
        var shouldHandleEvent = !disabled && (CoreUtils.isFunction(children) || CoreUtils.isFunction(content) || content !== undefined);
