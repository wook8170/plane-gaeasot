...
exports.withPreResponseHandler = exports.unsafeEjectStreamScope = exports.toWebHandlerRuntime = exports.toWebHandlerLayerWith = exports.toWebHandlerLayer = exports.toWebHandler = exports.toHandled = exports.fromWebHandler = exports.ejectDefaultScopeClose = exports.currentPreResponseHandlers = exports.appendPreResponseHandler = void 0;
...
const toHandled = (self, handleResponse, middleware) => {
  ...
  const withMiddleware = (0, _Unify.unify)(middleware === undefined ? internalMiddleware.tracer(withErrorHandling) : Effect.matchCauseEffect(internalMiddleware.tracer(middleware(withErrorHandling)), {
...
const fromWebHandler = handler => Effect.async((resume, signal) => {
  const fiber = Option.getOrThrow(Fiber.getCurrentFiber());
  const request = Context.unsafeGet(fiber.currentContext, ServerRequest.HttpServerRequest);
