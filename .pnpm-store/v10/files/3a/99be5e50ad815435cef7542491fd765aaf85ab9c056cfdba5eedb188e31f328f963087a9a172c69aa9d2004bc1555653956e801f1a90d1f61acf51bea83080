...
export type BaseUIChangeEventReason = 'trigger-press' | 'trigger-hover' | 'trigger-focus' | 'focus-out' | 'escape-key' | 'outside-press' | 'list-navigation' | 'item-press' | 'cancel-open' | 'none';
