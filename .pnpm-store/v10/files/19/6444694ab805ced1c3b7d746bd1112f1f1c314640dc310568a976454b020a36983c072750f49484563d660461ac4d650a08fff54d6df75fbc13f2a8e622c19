import {lazy,Component,Fragment,useState,useEffect,Suspense,useMemo,useCallback}from'react';import {css,jsx}from'storybook/theming';import {AddonPanel,Placeholder,Link,FlexBar,Separator,Tabs,IconButton}from'storybook/internal/components';import {FigspecFileViewer,FigspecFrameViewer}from'@figspec/react';import {addons,types,useParameter,useStorybookState}from'storybook/manager-api';import {ZoomIcon,ZoomOutIcon,ZoomResetIcon}from'@storybook/icons';var Ce=Object.defineProperty;var U=(e,r)=>()=>(e&&(r=e(e=0)),r);var ke=(e,r)=>{for(var o in r)Ce(e,o,{get:r[o],enumerable:true});};var w,Ie,Le,Ae,A=U(()=>{w=({config:e,defer:r=false})=>{let[o,t]=useState(r?void 0:e.url),[n,a]=useState(false);return useEffect(()=>{if(!r)return;let i=requestAnimationFrame(()=>{t(e.url);});return ()=>cancelAnimationFrame(i)},[r,e.url]),useEffect(()=>{a(false);},[o]),jsx("div",{css:Ie},!n&&jsx(Placeholder,{css:Le},"Loading..."),jsx("iframe",{css:Ae,src:o,allowFullScreen:e.allowFullscreen,onLoad:()=>a(true)}))},Ie=css`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
