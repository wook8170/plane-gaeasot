...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function () {
        ...
        var removeButton = isRemovable ? (React.createElement("button", { "aria-label": "Remove Tag", type: "button", className: common_1.Classes.TAG_REMOVE, onClick: this.onRemoveClick, tabIndex: tabIndex },
