...
export declare const retryTransient: {
     ...
     * @category error handling
     */
    <B, E, R1 = never, const Mode extends "errors-only" | "response-only" | "both" = never, Input = "errors-only" extends Mode ? E : "response-only" extends Mode ? ClientResponse.HttpClientResponse : ClientResponse.HttpClientResponse | E>(options: {
     ...
     * @category error handling
     */
    <E, R, B, R1 = never, const Mode extends "errors-only" | "response-only" | "both" = never, Input = "errors-only" extends Mode ? E : "response-only" extends Mode ? ClientResponse.HttpClientResponse : ClientResponse.HttpClientResponse | E>(self: HttpClient.With<E, R>, options: {
        readonly mode?: Mode | undefined;
        readonly while?: Predicate.Predicate<NoInfer<Input>>;
        readonly schedule?: Schedule.Schedule<B, NoInfer<Input>, R1>;
        readonly times?: number;
    } | Schedule.Schedule<B, NoInfer<Input>, R1>): HttpClient.With<E, R1 | R>;
};
/**
