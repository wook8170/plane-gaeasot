...
const make = exports.make = /*#__PURE__*/Effect.gen(function* () {
  ...
  const engine = (0, _WorkflowEngine.makeUnsafe)({
...
const ExitUnknown = /*#__PURE__*/Schema.Exit({
  success: Schema.Unknown,
...
const decodeDeferredWithExit = /*#__PURE__*/Schema.decodeSync(/*#__PURE__*/Reply.WithExit.schema(DeferredRpc));
