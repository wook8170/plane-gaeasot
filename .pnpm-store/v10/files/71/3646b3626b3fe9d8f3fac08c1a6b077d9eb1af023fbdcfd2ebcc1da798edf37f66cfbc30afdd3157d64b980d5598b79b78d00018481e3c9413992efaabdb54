...
export const Popover2Arrow = ({ arrowProps: { ref, style }, placement }) => (
// data attribute allows popper.js to position the arrow
React.createElement("div", { "aria-hidden": true, className: Classes.POPOVER2_ARROW, "data-popper-arrow": true, ref: ref, style: {
        ...style,
