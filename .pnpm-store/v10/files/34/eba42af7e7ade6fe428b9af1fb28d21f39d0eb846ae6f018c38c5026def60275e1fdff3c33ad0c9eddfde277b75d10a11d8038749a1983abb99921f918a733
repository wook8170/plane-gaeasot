...
var HTMLSelect = /** @class */ (function (_super) {
    ...
    HTMLSelect.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, disabled = _b.disabled, elementRef = _b.elementRef, fill = _b.fill, _c = _b.iconName, iconName = _c === void 0 ? "double-caret-vertical" : _c, iconProps = _b.iconProps, large = _b.large, minimal = _b.minimal, _d = _b.options, options = _d === void 0 ? [] : _d, htmlProps = tslib_1.__rest(_b, ["className", "disabled", "elementRef", "fill", "iconName", "iconProps", "large", "minimal", "options"]);
        ...
        return (React.createElement("div", { className: classes },
            React.createElement("select", tslib_1.__assign({ disabled: disabled, ref: elementRef, value: this.props.value }, htmlProps, { multiple: false }),
                optionChildren,
                htmlProps.children),
            React.createElement(icon_1.Icon, tslib_1.__assign({ icon: iconName, title: "Open dropdown" }, iconProps))));
    };
    return HTMLSelect;
