...
var ButtonGroup = /** @class */ (function (_super) {
    ...
    ButtonGroup.prototype.render = function () {
        var _a;
        var _b = this.props, alignText = _b.alignText, className = _b.className, elementRef = _b.elementRef, fill = _b.fill, minimal = _b.minimal, large = _b.large, vertical = _b.vertical, htmlProps = tslib_1.__rest(_b, ["alignText", "className", "elementRef", "fill", "minimal", "large", "vertical"]);
        ...
        return (React.createElement("div", tslib_1.__assign({}, htmlProps, { className: buttonGroupClasses, ref: elementRef }), this.props.children));
    };
