 ...
 * @since 1.0.0
 */
export type PrimitiveKind = "string" | "number" | "bigint" | "boolean" | "Date" | "null" | "Int8Array" | "Uint8Array" | "object";
/**
 * @category model
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export declare const unsafeFragment: (sql: string, params?: ReadonlyArray<unknown> | undefined) => Fragment;
/**
 * @category constructor
 * @since 1.0.0
 */
