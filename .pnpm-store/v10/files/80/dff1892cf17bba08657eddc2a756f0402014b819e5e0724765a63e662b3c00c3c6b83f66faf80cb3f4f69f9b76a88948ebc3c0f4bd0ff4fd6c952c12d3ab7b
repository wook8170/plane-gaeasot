...
var MenuItem = /** @class */ (function (_super) {
    ...
    MenuItem.prototype.render = function () {
        ...
        var target = React.createElement(tagName, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ 
            ...
            role: hasSubmenu ? "none" : targetRole, tabIndex: hasSubmenu ? -1 : 0 }, htmlProps), (disabled ? DISABLED_PROPS : {})), { className: anchorClasses }), hasIcon ? (
    ...
    MenuItem.prototype.maybeRenderPopover = function (target, popoverTargetProps, children) {
        if (children == null) {
            return target;
        }
